<template>
	<view class="select-page">
		<view class="header">
			...
			<text class="header-title">操作人</text>
...
import { getInspectionOperators } from '@/api/mock.js'
...
async function loadOperators() {
	try {
		const res = await getInspectionOperators()
		if (res.code === 0) {
...
function handleConfirm() {
	...
	uni.$emit('inspectionOperatorSelected', selectedValue.value)
	uni.navigateBack()
}
