<template>
	<view class="detail-page">
		<view class="header">
			...
			<text class="header-title">入库详情</text>
		...
		<scroll-view class="content-scroll" scroll-y>
			<view class="info-section">
				<view class="info-row">
					<text class="info-label">入库编号</text>
					<text class="info-value">{{ detailData.code }}</text>
				</view>
				<view class="info-row">
					<text class="info-label">入库名称</text>
				...
				<view class="info-row">
					<text class="info-label">接收数量</text>
				...
				<view class="info-row">
					...
					<text class="info-value">{{ detailData.inboundTime }}</text>
				</view>
				<view class="info-row">
					<text class="info-label">供应商名称</text>
					<text class="info-value">{{ detailData.supplierName }}</text>
				</view>
				<view class="info-row">
					<text class="info-label">入库人</text>
					<text class="info-value">{{ detailData.inboundPerson }}</text>
				</view>
			</view>
...
import { getPurchaseInboundDetail } from '@/api/mock.js'
