<template>
	<view class="detail-page">
		<view class="header">
			...
			<text class="header-title">退料详情</text>
		...
		<scroll-view class="content-scroll" scroll-y>
			<view class="info-section">
				<view class="info-row">
					<text class="info-label">退料编号</text>
					<text class="info-value">{{ detailData.code }}</text>
				</view>
				<view class="info-row">
					<text class="info-label">退料单名称</text>
				...
				<view class="info-row">
					<text class="info-label">退料人</text>
					<text class="info-value">{{ detailData.returnPerson }}</text>
				</view>
				<view class="info-row">
					<text class="info-label">退料日期</text>
					<text class="info-value">{{ detailData.returnDate }}</text>
				</view>
				<view class="info-row">
				...
				<view class="info-row">
					<text class="info-label">退料数量</text>
...
import { getMaterialReturnDetail } from '@/api/mock.js'
...
async function loadDetail(id) {
	...
	try {
		const res = await getMaterialReturnDetail({ id })
