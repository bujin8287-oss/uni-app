<template>
	<view class="detail-page">
		<view class="header">
			...
			<text class="header-title">出库详情</text>
		...
		<scroll-view class="content-scroll" scroll-y>
			<view class="info-section">
				<view class="info-row">
					<text class="info-label">出库编号</text>
					<text class="info-value">{{ detailData.code }}</text>
				</view>
				<view class="info-row">
					<text class="info-label">出库名称</text>
				...
				<view class="info-row">
					...
					<text class="info-value">{{ detailData.outboundTime }}</text>
				</view>
				<view class="info-row">
				...
				<view class="info-row">
					<text class="info-label">出库人</text>
					<text class="info-value">{{ detailData.outboundPerson }}</text>
				</view>
			</view>
...
import { getProductOutboundDetail } from '@/api/mock.js'
...
async function loadDetail(id) {
	...
	try {
		const res = await getProductOutboundDetail({ id })
