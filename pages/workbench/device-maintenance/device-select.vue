<template>
	<view class="select-page">
		<view class="header">
			...
			<text class="header-title">设备选择</text>
...
import { getMaintenanceDevices } from '@/api/mock.js'
...
async function loadDevices() {
	try {
		const res = await getMaintenanceDevices()
		if (res.code === 0) {
...
function handleConfirm() {
	...
	uni.$emit('maintenanceDeviceSelected', selectedValue.value)
	uni.navigateBack()
}
